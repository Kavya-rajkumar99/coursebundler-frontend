...
const Subscribe = ({user}) => {
  ...
  const {isLoading,error,subscriptionId} = useSelector(state=>state.subscription)
  ...
  return (
    <Container minH="95vh" p="16">
      ...
      <VStack boxShadow={"lg"} borderRadius={"lg"} alignItems="stretch" spacing="0">
        <Box bg="yellow.400" p="4" css={{borderRadius:"8px 8px 0 0"}}>
        <Text fontWeight={"bold"} textAlign="center" fontSize="sm" fontFamily={"cursive"}>Pro Pack - ₹299.00</Text>
        </Box>
        <Box p="4">
